...
# from transformers.deprecated._archive_maps import GPT_NEO_PRETRAINED_CONFIG_ARCHIVE_MAP  # noqa: F401, E402


class SparseGPTNeoConfig(PretrainedConfig):
    r"""
