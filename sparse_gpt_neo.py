...
_CHECKPOINT_FOR_DOC = "eugene/sparse-gpt-neo"
...
class SparseGPTNeoBlock(nn.Module):
    ...
    def forward(
        ...
        #print("input shape to FFN", hidden_states.shape)
...
class SparseGPTNeoPreTrainedModel(PreTrainedModel):
    ...
    _no_split_modules = ["SparseGPTNeoBlock"]
...
SPARSE_GPT_NEO_START_DOCSTRING = r"""
    ...
    Parameters:
        config ([`SparseGPTNeoConfig`]): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the
            configuration. Check out the [`~PreTrainedModel.from_pretrained`] method to load the model weights.
"""

SPARSE_GPT_NEO_INPUTS_DOCSTRING = r"""
    Args:
...
@add_start_docstrings(
    "The sparse GPT Neo Model transformer outputting raw hidden-states without any specific head on top.",
    SPARSE_GPT_NEO_START_DOCSTRING,
)
class SparseGPTNeoModel(SparseGPTNeoPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(SPARSE_GPT_NEO_INPUTS_DOCSTRING)
    @add_code_sample_docstrings(
...
class SparseGPTNeoForCausalLM(SparseGPTNeoPreTrainedModel):
